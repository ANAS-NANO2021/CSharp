...
{
    public partial class AnamezPanel : Form
    {
        ...
        public AnamezPanel(int randevuid)
        {
            this.randevuid= randevuid;
            InitializeComponent();
            db.Muayeneldu(this.randevuid);

            // Aşağıda Randevuya Ait
        ...
        {
            RandevuRecete RCT = new RandevuRecete(randevuid);
            this.Hide();
            RCT.Show();
        ...
        {
            RandevuTanı rt = new RandevuTanı(randevuid);
            rt.Show();
            this.Hide();
        }
        ...
        private void taniyenile_Click(object sender, EventArgs e)
        {
            tanilardgv.DataSource = db2.randevutanigetir(randevuid).Tables[0].DefaultView;
        }

        private void ilacyenile_Click(object sender, EventArgs e)
        {
            ilaclardgv.DataSource = db.randevuilacgetir(randevuid).Tables[0].DefaultView;
        }
    }
