...
namespace OrtaDünyaPansiyonKayıt
{
    public partial class FrmAnaForm : Form
    {
        ...
        {
            MessageBox.Show("Orta Dünya Pansiyon Kayıt Uygulaması/2021/Staj Projesi/BATMAN");
        }
        ...
        private void TxtPersonelMaas_Click(object sender, EventArgs e)
        {
        ...
        {
            FrmSifreGüncelleme fr = new FrmSifreGüncelleme();
            fr.Show();
        }
    }
}
